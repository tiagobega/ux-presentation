...
export const osImages: OSImage[] = [
  ...
  { id: 5, bronze: 'aprovada', detection: 'Sinalização (segurança)', ouro: 'validada' },
  {
    id: 6,
    bronze: 'aprovada',
...
export const criterios: Criterio[] = [
  ...
  { label: 'Material utilizado', ok: true, obs: 'Evidência validada' },
  //precisa ficar amarelo, tem mas ta meia bomba por que falta imagens
...
export const osList: OS[] = [
  ...
  {
    numero: '1049',
    nome: 'Substituição de hidrômetro',
    origem: 'WFM',
    imagens: 0,
