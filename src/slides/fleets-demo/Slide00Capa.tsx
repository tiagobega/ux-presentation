  ...
  return (
    ...
    >
      ...
      <div>
        ...
        <h1 className='text-[150px] font-bold leading-[0.88] tracking-[-0.05em] text-purple'>
          {splitToWords('Fleets')}
        </h1>
        <p
          data-subtitle
      ...
      >
        <span>Slides aqui · aplicação ao vivo no monitor ao lado</span>
        <span>Agosto 2026 · Tiago Bega</span>
      </div>
    </div>
  )
}
