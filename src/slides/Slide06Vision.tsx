...
export default function Slide06Vision({ action }: SlideProps) {
  ...
  return (
    ...
    >
      ...
      {/* camadas: a foto passa por cima revelando o que cada uma faz */}
      ...
      {phase >= 2 && (
        <motion.div
          key="expansao"
          {...up(0.2, easeIn)}
          className="border-t border-text/10 pt-5 flex flex-col gap-4"
        >
          <div className="text-center text-[16px] font-mono tracking-[0.14em] uppercase text-purple/50">
            A mesma arquitetura, pronta para novos clientes e verticais
          </div>
