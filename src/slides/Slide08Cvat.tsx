...
export default function Slide08Cvat({ action: _ }: SlideProps) {
  return (
    <BulletSlide
      ...
      paragraph="Descontinuamos o desenvolvimento interno do SGC 2.0 ao encontrar o CVAT, uma alternativa open source, madura e validada."
      bullets={[
        { Icon: XCircle, text: "Desenvolvimento interno do SGC descontinuado" },
        {
          Icon: Package,
          text: "CVAT identificado como alternativa open source",
        },
        {
          Icon: CheckCircle2,
          text: "Time de IA estudou e validou a adoção do CVAT",
        },
        { Icon: Clock, text: "Meses de trabalho economizados" },
        {
          Icon: Rocket,
          text: "Time liberado para o que só nós podemos construir: Vision e Fleets",
        },
      ]}
    />
  );
